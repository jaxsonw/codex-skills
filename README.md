# Jaxson's Curated Codex Skills

这是一个面向 Codex 用户的公开 skills 体验仓库：把官方示例、社区整理的可复用 skill 放在一起，方便安装、试用和继续二次整理。
...
仓库最初参考了 [`openai/skills`](https://github.com/openai/skills)。导入的官方/社区 skill 会尽量保留原始许可证和说明。
